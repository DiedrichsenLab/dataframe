...
while(c<=length(varargin))
    switch(varargin{c})
        ...
        case 'style_thickline'
            F.linecolor={[0.2000    0.1333    0.5333],[0.0667    0.4667    0.2000],[0.5333    0.8000    0.9333],[0.8667    0.8000    0.4667],[0.5333    0.1333    0.3333],[0.7 0.7 0.7],[1 1 0]};
            F.markercolor={[0.2000    0.1333    0.5333],[0.0667    0.4667    0.2000],[0.5333    0.8000    0.9333],[0.8667    0.8000    0.4667],[0.5333    0.1333    0.3333],[0.7 0.7 0.7],[1 1 0]};
            F.errorcolor={[0.2000    0.1333    0.5333],[0.0667    0.4667    0.2000],[0.5333    0.8000    0.9333],[0.8667    0.8000    0.4667],[0.5333    0.1333    0.3333],[0.7 0.7 0.7],[1 1 0]};
            F.markertype='s';
            F.markersize=2.5;
            F.linewidth=2.5;
            F.errorwidth=1;
            F.shadecolor={[0.2000    0.1333    0.5333],[0.0667    0.4667    0.2000],[0.5333    0.8000    0.9333],[0.8667    0.8000    0.4667],[0.5333    0.1333    0.3333],[0.7 0.7 0.7],[1 1 0]};
            c=c+1;
